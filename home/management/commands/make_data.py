...
# Dummy product data
PRODUCT = {
	"name": ["Cheesecake", "Bagel", "Brownie", "Cupcake", "Cookie", "Donut", "Pretzel", "Turnover", "Croissant", "Baklava"],
	"description": [
	...
	"updater": [ADMIN1, ADMIN1, ADMIN2, ADMIN2, ADMIN3, ADMIN3, ADMIN4, ADMIN4, ADMIN5, ADMIN5],
}
...
BLOG_POSTS = {
	"title": ["A Blog Post About Cheesecakes", "A Blog Post About Bagels", "A Blog Post About Brownies", "A Blog Post About Cupcakes", "A Blog Post About Cookies"],
	"preview_text": [
	...
	"status": [Post.ACTIVE, Post.ACTIVE, Post.ACTIVE, Post.ACTIVE, Post.ACTIVE],
	"creator": [ADMIN1, ADMIN1, ADMIN2, ADMIN3, ADMIN4],
	"updater": [ADMIN1, ADMIN1, ADMIN2, ADMIN3, ADMIN4],
}
