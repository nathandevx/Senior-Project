...
# Dummy product data
PRODUCT = {
	"name": ["Cheesecake", "Bagel", "Brownie", "Cupcake", "Cookie", "Donut", "Pretzel", "Turnover", "Croissant", "Baklava", "Fudge", "Muffin"],
	"description": [
	...
	"estimated_delivery_date": [datetime(2050, 1, 15, 0, 0), datetime(2051, 1, 20, 0, 0), datetime(2052, 1, 28, 0, 0),
								datetime(2053, 2, 2, 0, 0), datetime(2054, 2, 5, 0, 0), datetime(2055, 2, 23, 0, 0),
								datetime(2056, 2, 25, 0, 0), datetime(2057, 3, 12, 0, 0), datetime(2058, 3, 21, 0, 0),
								datetime(2059, 3, 24, 0, 0), datetime(2060, 3, 29, 0, 0), datetime(2061, 4, 10, 0, 0)],
	"status": [Product.ACTIVE, Product.ACTIVE, Product.ACTIVE, Product.ACTIVE, Product.ACTIVE, Product.ACTIVE, Product.ACTIVE, Product.ACTIVE, Product.ACTIVE, Product.ACTIVE, Product.INACTIVE, Product.INACTIVE],
	"stock": [50, 45, 40, 35, 30, 25, 20, 15, 10, 5, 0, 0],
	"creator": [ADMIN1, ADMIN1, ADMIN2, ADMIN2, ADMIN3, ADMIN3, ADMIN4, ADMIN4, ADMIN5, ADMIN5, ADMIN1, ADMIN2],
	"updater": [ADMIN1, ADMIN1, ADMIN2, ADMIN2, ADMIN3, ADMIN3, ADMIN4, ADMIN4, ADMIN5, ADMIN5, ADMIN1, ADMIN2],
}
