...
class TestOrdersList(OrderBaseTestCase):
	...
	def test_user_access(self):
		...
		self.assertEqual(resolve(self.url).func, orders.order_list)
		...
		for order in context['orders']:
			self.assertEqual(order.creator, self.user1)
...
class TestOrderConfirmation(OrderBaseTestCase):
	...
	def test_get_request(self):
		...
		self.assertEqual(resolve(self.user_1_url).func, orders.order_confirmation)
		...
		self.assertEqual(context['order'], self.order1)
		self.assertEqual(context['order_model'], Order)
